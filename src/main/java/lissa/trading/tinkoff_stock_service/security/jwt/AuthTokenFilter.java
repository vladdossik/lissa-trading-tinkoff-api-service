package lissa.trading.tinkoff_stock_service.security.jwt;
...
import lissa.trading.tinkoff_stock_service.security.AuthServiceClient;
import lissa.trading.tinkoff_stock_service.security.EncryptionService;
...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain)
        ...
        try {
            ...
            String tinkoffToken = EncryptionService.decrypt(userInfo.getTinkoffToken());
